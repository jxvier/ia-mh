---
title: "Cuaderno 01 — Del producto final al proceso "
description: Evaluar aprendizaje en tiempos de IA
date: 2026-07-14
---
...
==La evidencia de proceso es cualquier registro, explicación o demostración que permite observar cómo se construyó un trabajo. Puede incluir bitácoras, bocetos, versiones intermedias, prompts, capturas, defensas orales, decisiones justificadas, revisores, prototipos, reflexiones o preguntas respondidas en clase.=={.verde}
...
==La trazabilidad es la posibilidad de reconstruir cómo se llegó a un resultado. Permite ver versiones, decisiones, ajustes, fuentes, interacciones con herramientas y cambios realizados durante el proceso.=={.verde}
...
==La presencia de IA en el aula puede generar silencios. Muchos estudiantes usan herramientas de IA sin declararlo con claridad porque no siempre saben qué se espera de ellos, qué usos son aceptables o cómo será interpretado su uso. Simultáneamente, los docentes pueden apoyarse de IA para generar materiales de clase sin divulgarlo a sus estudiantes. Para transformar esa ambigüedad, necesitamos promover transparencia de proceso.=={.verde} 

Término clave: Transparencia de proceso 
La transparencia de proceso consiste en hacer visible cómo se construyó un trabajo, especialmente cuando se utilizaron herramientas de IA. Puede incluir qué herramienta se usó, con qué propósito, qué se aceptó, qué se modificó, qué se rechazó y qué decisiones humanas guiaron el resultado. 
...
==Cuando evaluamos únicamente el producto final, corremos el riesgo de premiar entregas bien presentadas que no muestran comprensión suficiente. También podemos penalizar procesos valiosos que todavía necesitan mejorar en forma, claridad o ejecución.=={.morado}

==En tiempos de IA, este riesgo aumenta porque las herramientas pueden elevar la apariencia de una entrega sin garantizar aprendizaje profundo.=={.morado}

==Por eso, la evaluación debe incluir evidencia suficiente del proceso. Esta evidencia protege al docente, al estudiante y a la comunidad académica. Ayuda a reconocer aprendizaje real, detectar vacíos de comprensión y sostener conversaciones más justas.=={.morado}

==También elimina la necesidad de recurrir a mecanismos de sospecha, como detectores de IA. Cuando el diseño de la actividad permite ver el camino, el docente depende menos de interpretar apariencias.=={.morado}
